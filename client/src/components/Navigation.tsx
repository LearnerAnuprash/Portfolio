  ...
  return (
    <div className="min-h-50px flex items-start justify-center pt-4">
      <nav className="flex justify-center">
        <ul className=" relative flex justify-center gap-8 bg-white/5 backdrop-blur-lg p-4 rounded-3xl border border-white/30 shadow-xl">
          ...
          <div className="absolute inset-0 z-[1] bg-black/30 backdrop-blur-lg rounded-3xl"></div>
